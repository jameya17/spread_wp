                            ...
                            <p class="mb10">
                                ...
                                <ol class="comp-condition number-list">
                                    <li>
                                        ...
                                        <div class="publisher-details">
                                            <span>Handelsgericht Wien Firmenbuchnummer: 505341z</span>
                                            <span>UID: ATU74063069</span>
                                        </div>
                                        <div class="publisher-details">
                                        ...
                                        <ol class="alpha-list" style="margin-top:20px">
                                            <li><p class="mb10">Physical, nutritional, fitness and medical information as may be required for the effective performance of the Services offered (“<strong>Physical Data</strong>”).</p></li>
                        
                                            <li><p class="mb10">Information that does not reveal the identity of the User in any way, for example, the details of the User’s browser and operating system, time spent using Fitterfly’s Services, other webpages visited by the User, unique identifiers of the device on which FitterFly, information of WiFi connectivity etc. Such information shall hereinafter be referred to as “<strong>Other Information</strong>”.</p></li>
                        
                                            <li><p class="mb10">GPS signals, device sensors, Wi-Fi access points, and cell tower IDs. This information is stored in the User’s FitterFly account and is used to display the User’s location on a map (“<strong>Location Data</strong>”).</p>
                                            </li>
                        
                                            <li><p class="mb10">Credit card or other payment account information, which will be used solely for processing payments (“<strong>Payment Information</strong>”).</p>
                                            </li>
                                        </ol>
                                        </li>
                        
                                        <li><p class="mb10">
                                        User’s Payment Information will not be stored on FitterFly except for the name and address of the card holder, the expiry date and the last four digits of the credit card number. Subject to the User’s prior consent and where necessary for processing future payments, Payment Information of the User will be stored in encrypted form on secure servers of the reputed payment gateway service provider of FitterFly. The payment gateway service provider will be treat such information in accordance with their Privacy Policy Statement, available on their respective websites.</p>
                                        </li>
                        
                                        <li><p class="mb10">
                                        Company will retain the User’s Personal Information even after the user closes his account with Fitterfly. Company will also retain and use the Personal Information as necessary to comply with its legal obligations, resolve disputes, and enforce any agreements.</p>
                                        </li>
                        
                                        <li><p class="mb10">
                                        <strong>Anonymous Data.</strong> FitterFly may also collect such other anonymous data that is not associated with or linked to any Personal Data (“<strong>Anonymous Data</strong>”) and which, by itself, does not pertain to the identification of any individual User. Anonymous Data includes without limitation, unique identifiers of the device on which the Website is used such as VPN, information of Wi-Fi connectivity and such other information. The Website may also store these unique identifiers, at times and create a profile for you based on such Anonymous Data, which in turn allows you to have a better browsing experience on the Website.</p>
                                        </li>
                        
                                        <li><p class="mb10">
                                        <strong>Usage Information.</strong> In addition, FitterFly may automatically collect certain other information, including but not limited to usernames, passwords, and other security and usage related information, whenever you visit or utilize the Services such as Log Data, Analytical Code, Time Stamp, Geo Stamp, IP address, version and identification number of the  device, browser type, browser language, the date and time of your request, your profile, websites visited by you, search terms used, platform type, number of clicks,  phone number, requested status of other Users and various status information and other personal setting information with regard to your usage of the Services provided through the Website (“<strong>Usage Information</strong>”). Such Usage Information collected is not associated with any Personal Data and is tagged to the unique identifier of a particular device.</p>
                                        </li>
                        
                                        <li><p class="mb10">
                                        <strong>Cookies.</strong> FitterFly uses data collection devices such as “cookies” on your device / computer through which it is accessed that assist in (a) providing Services; and (b) to allow you to enter your password less frequently during a session.</p>
                                        </li>
                                    </ol> -->
                                    </li>
